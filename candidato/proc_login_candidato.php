    ...
    $senha = $_POST["senha"];
        ...
        require './conecta_bd.php'; // Verificando a conexão com o banco de dados
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo '<script type="text/javascript">alert("Cadastro realizado com sucesso! Aproveite as vantagens do nosso site."); window.location.href = "serv_candidato.php";</script>';
            } else {
